        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="w-full max-w-md rounded-2xl bg-white dark:bg-[#1C1719] p-6 shadow-2xl border border-[var(--border-color)] space-y-4">
            ...
            <div className="flex justify-end gap-2 pt-2">
              ...
              {storePhoneOrWhatsApp && (
                <a
                  href={`https://wa.me/${storePhoneOrWhatsApp.replace(/[^0-9]/g, '')}?text=${encodeURIComponent('Hello CR Cosmetics and Essential, I need assistance accessing my account.')}`}
                  target="_blank"
                  rel="noreferrer"
    ...
    <AuthShell mode="signup">
      <div className="space-y-7">
        <div className="space-y-2">
          ...
          <p className="text-sm text-[var(--text-muted)]">Join CR Cosmetics and Essential for faster checkouts, order tracking, and account management.</p>
        </div>
          ...
          <div className="w-full max-w-2xl rounded-3xl bg-white dark:bg-[#1C1719] p-6 sm:p-8 shadow-2xl border border-[#F0E4DC] dark:border-[#2C2426] space-y-6 max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between border-b border-[#F0E4DC] dark:border-[#2C2426] pb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-base font-black text-[#1C1817] dark:text-stone-100">CR Cosmetics and Essential</h3>
