      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-white dark:bg-[#1C1917] p-6 rounded-3xl border border-[#E6DFD7] dark:border-[#36322E] h-fit space-y-6">
          ...
          <div className="space-y-3 text-xs">
            ...
            <div className="flex justify-between text-stone-600">
              <span>Standard Accra Delivery:</span>
...
export const MultiStepCheckoutPage: React.FC = () => {
  ...
  const shippingFee = deliveryMethod === 'accra-express' ? 40 : deliveryMethod === 'intercity' ? 50 : 25;
        ...
        {step === 1 && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                <label className="text-xs font-bold text-stone-700 block mb-1">City / Region</label>
                <input
                  type="text"
                  value={city}
              ...
              <div>
                <label className="text-xs font-bold text-stone-700 block mb-1">Area / Landmark</label>
                <input
                  type="text"
                  required
                  value={area}
