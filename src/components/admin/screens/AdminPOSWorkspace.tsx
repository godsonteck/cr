...
export function AdminPOSWorkspace() {
  ...
  const checkout = (
    <section className="sticky top-24 z-20 flex h-[calc(100vh-8rem)] max-h-[calc(100vh-8rem)] self-start overflow-hidden flex-col rounded-[24px] border border-[#e8d9d2] bg-[#fffdfb] p-4 shadow-[0_18px_50px_rgba(36,25,27,0.08)] dark:border-[#3b2b2f] dark:bg-[#1e1719] sm:p-5">
  ...
  return <div className="min-h-[calc(100vh-7rem)] space-y-4">
    ...
    <div className="grid grid-cols-[minmax(0,1fr)_440px] items-stretch gap-6">
