...
export function AdminPOSWorkspace() {
  ...
  const checkout = (
    <section className="flex min-h-[calc(100vh-8rem)] flex-col rounded-[24px] border border-[#e8d9d2] bg-[#fffdfb] p-4 shadow-[0_18px_50px_rgba(36,25,27,0.08)] dark:border-[#3b2b2f] dark:bg-[#1e1719] sm:p-5 xl:sticky xl:top-24">
