...
export const TrustBar: React.FC = () => {
  return (
    <section className="bg-[#FAF5F3] border-y border-rose-100 py-8 sm:py-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          
          {/* 1. 100% AUTHENTIC PRODUCTS */}
          <div className="flex items-center gap-3.5">
            <div className="w-11 h-11 rounded-full bg-white text-[#8A3D52] shadow-xs flex items-center justify-center shrink-0 border border-rose-100/80">
          ...
          <div className="flex items-center gap-3.5">
            <div className="w-11 h-11 rounded-full bg-white text-[#8A3D52] shadow-xs flex items-center justify-center shrink-0 border border-rose-100/80">
              <Heart className="w-5 h-5 text-[#8A3D52]" />
            </div>
            <div>
              <h4 className="text-xs font-black text-gray-900 tracking-wider uppercase">
                PREMIUM CURATION
          ...
          <div className="flex items-center gap-3.5">
            <div className="w-11 h-11 rounded-full bg-white text-[#8A3D52] shadow-xs flex items-center justify-center shrink-0 border border-rose-100/80">
              <Truck className="w-5 h-5 text-[#8A3D52]" />
            </div>
            <div>
              <h4 className="text-xs font-black text-gray-900 tracking-wider uppercase">
                EXPRESS DISPATCH
          ...
          <div className="flex items-center gap-3.5">
            <div className="w-11 h-11 rounded-full bg-white text-[#8A3D52] shadow-xs flex items-center justify-center shrink-0 border border-rose-100/80">
              <Headphones className="w-5 h-5 text-[#8A3D52]" />
            </div>
            <div>
              <h4 className="text-xs font-black text-gray-900 tracking-wider uppercase">
                BEAUTY CONCIERGE
