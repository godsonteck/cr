...
${discount > 0 ? `*Discount (${promoCode}):* -GHS ${discount.toFixed(2)}\n` : ''}*Delivery (Accra):* ${shippingFee === 0 ? 'FREE' : `GHS ${shippingFee.toFixed(2)}`}
*Total:* *GHS ${total.toFixed(2)}*

Please confirm delivery to my location in Accra. Thank you!`;
        ...
        <div className="bg-[#FAF5F4] px-4 py-2.5 border-b border-rose-100 text-xs">
          {subtotal >= freeShippingThreshold ? (
            <div className="flex items-center gap-1.5 text-[#8A3D52] font-bold">
              ...
              <span>🎉 Congratulations! You have qualified for FREE Delivery in Accra!</span>
            </div>
          ) : (
