  ...
  return (
    <>
      ...
      <style jsx>{`
        ...
        .cr-topbar{height:34px;background:var(--burgundy-mid, #8d3d59);color:#fff;display:flex;align-items:center;justify-content:center;gap:clamp(18px,5vw,70px);font:600 8px/1 var(--font-primary);letter-spacing:.1em;text-transform:uppercase}.cr-topbar i{height:13px;width:1px;background:rgba(255,255,255,.35)}
        .cr-header-inner{max-width:1480px;height:84px;margin:auto;padding:0 clamp(20px,5vw,64px);display:grid;grid-template-columns:1fr auto 1fr;align-items:center}.cr-header-desktop-nav{display:flex;gap:22px;align-items:center}.cr-nav-link{color:#30242a;text-decoration:none;font:600 10px/1 var(--font-primary);text-transform:uppercase;letter-spacing:.04em;padding:12px 0}.cr-nav-link:hover,.cr-nav-link--active{color:var(--burgundy)}.cr-nav-chevron{font-size:12px;margin-left:5px;color:#9a808a}
        .cr-brand-logo{justify-self:center;display:flex;align-items:center;gap:12px;text-decoration:none;color:#171116}.cr-brand-logo-img{width:46px;height:46px;border-radius:50%;object-fit:cover;border:1.5px solid var(--gold, #c59b3f);box-shadow:0 2px 8px rgba(107,23,51,.12);transition:transform .2s ease}.cr-brand-logo:hover .cr-brand-logo-img{transform:scale(1.05)}.cr-brand-text{display:flex;flex-direction:column;line-height:1.05}.cr-brand-name{font:700 1.25rem/1 var(--font-display, Georgia, serif);letter-spacing:-.02em;color:var(--text, #171116)}.cr-brand-sub{font:700 .62rem/1 var(--font-primary);letter-spacing:.14em;margin-top:4px;color:var(--burgundy, #6b1733);text-transform:uppercase}
        .cr-header-actions{display:flex;justify-content:flex-end;align-items:center;gap:3px}.cr-search-trigger,.cr-action-icon{border:0;background:none;color:#30242a;display:flex;align-items:center;justify-content:center;position:relative;cursor:pointer}.cr-search-trigger{gap:7px;padding:9px 8px;font:500 10px var(--font-primary)}.cr-action-icon{width:40px;height:40px}.cr-search-trigger:hover,.cr-action-icon:hover{color:var(--burgundy)}.cr-count{position:absolute;top:1px;right:0;min-width:14px;height:14px;border-radius:50%;background:var(--burgundy);color:#fff;display:flex;align-items:center;justify-content:center;font:700 7px var(--font-primary)}
        ...
        .cr-mobile-drawer{display:none;position:fixed;inset:0;z-index:99;background:#fff8f6;opacity:0;pointer-events:none;transition:opacity .2s}.cr-mobile-drawer.is-open{opacity:1;pointer-events:auto}.cr-mobile-drawer-inner{height:100%;padding:115px 24px 30px;display:flex;flex-direction:column}.cr-mobile-eyebrow{font:700 9px var(--font-primary);letter-spacing:.18em;color:#9b6879;margin:0 0 25px}.cr-mobile-links{border-top:1px solid #e8dade}.cr-mobile-link{display:grid;grid-template-columns:30px 1fr auto;gap:8px;padding:19px 0;border-bottom:1px solid #e8dade;text-decoration:none;color:#281a20;font:400 29px/1 var(--font-display)}.cr-mobile-number{font:700 8px var(--font-primary);color:#aa929b}.cr-mobile-contact{margin-top:auto;font:400 12px/1.6 var(--font-primary);color:#76636b}.cr-mobile-contact a{color:var(--burgundy);font-weight:700}.cr-mobile-contact p{margin-top:7px}
        @media(max-width:1100px){.cr-header-inner{height:80px}.cr-header-desktop-nav{gap:12px}.cr-nav-link{font-size:9px}.cr-brand-logo-img{width:40px;height:40px}.cr-brand-name{font-size:1.1rem}.cr-brand-sub{font-size:.58rem}.cr-search-trigger span{display:none}}
        @media(max-width:800px){.cr-topbar{height:30px;font-size:7px;gap:0}.cr-topbar span{display:none}.cr-topbar span:first-child{display:block}.cr-topbar i{display:none}.cr-header-inner{height:68px;display:grid;grid-template-columns:1fr auto}.cr-header-desktop-nav{display:none}.cr-brand-logo{justify-self:start}.cr-brand-logo-img{width:36px;height:36px}.cr-brand-name{font-size:1rem}.cr-brand-sub{font-size:.52rem;margin-top:2px}.cr-action-icon{width:35px}.cr-mobile-toggle{display:flex}.cr-mobile-drawer{display:block}}
      `}</style>
    </>
  );
}
