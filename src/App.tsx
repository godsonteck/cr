...
function AppLayout() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#FDFBF7] dark:bg-[#12100F] text-[#1C1817] dark:text-stone-100 font-sans selection:bg-[#C86D51] selection:text-white transition-colors">
      <Header
