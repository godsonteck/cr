...
export const metadata = {
  ...
  description:
    'Shop authentic verified skincare, radiant body care, and quality everyday grocery essentials at CR Cosmetics & Essentials. Based in Botwe, near Galaxy International School, Accra, Ghana.',
  ...
  openGraph: {
    title: `${BUSINESS.name} | Beauty & Everyday Essentials`,
    description: 'Beauty products and everyday essentials in Botwe, Accra.',
    type: 'website',
    locale: 'en_GH',
    url: 'https://cr-cosmetics.vercel.app',
    siteName: BUSINESS.name,
    images: [{ url: '/images/hero-pedestal.jpg', width: 1200, height: 630, alt: 'CR Cosmetics & Essentials Ghana' }],
  },
  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta name="theme-color" content="#2A1820" />
