...
async function runMigration() {
  ...
  const tables = [
    ...
    `CREATE TABLE "notifications" ("id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL, "user_id" uuid, "type" varchar(30) NOT NULL, "title" varchar(200) NOT NULL, "message" text NOT NULL, "action_url" varchar(255), "is_read" boolean DEFAULT false NOT NULL, "created_at" timestamp DEFAULT now() NOT NULL)`,
